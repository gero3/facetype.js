...
function parseBuffer(buffer) {
    ...
    for (i = 0; i < numTables; i += 1) {
        ...
        case 'name':
            ...
            font.familyName = font.tables.name.font_family_name;
            font.styleName = font.tables.name.font_sub_family_name;
            break;
        case 'OS/2':
...
var nameTableNames = [
    ...
    'sampleText',             // 19
    'postScriptFindFontName', // 20 (?) I'm not sure of this in THREE.JS.
    'wws_family',             // 21
    'wws_subfamily'           // 22
];
